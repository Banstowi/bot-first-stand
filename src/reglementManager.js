...
const SECTIONS = [
  ...
  },
  {
    ...
    description: [
      ...
      '',
      '**⚖️ Égalité de points**',
      '• En cas d\'égalité entre les points de **2 équipes**, le **head to head** départagera le positionnement.',
      '• En cas de **triangulation**, nous regarderons le head to head, puis si cela n\'est pas suffisant, le nombre de **nexus tombés** (+1 par nexus) et **perdus** (-1 par nexus). Pour finir par le **temps de game moyen**.',
      '',
  ...
  },
  {
    ...
    description: [
      ...
      '**4.** Tous les rôles doivent être sélectionnés correctement dans le client. Il ne peut y avoir **2 personnes différentes sur un même rôle**.',
      '',
